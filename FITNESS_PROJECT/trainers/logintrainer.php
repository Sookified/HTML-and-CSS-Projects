...

{
	...
	$q= "SELECT * FROM regtrainer WHERE email='$e' AND password='$p'";
	$r=mysqli_query($c,$q);
...
<h2 style="text-align:right; padding-top:15px"> Home </h2></a></p>
...
<p style="text-align:center; font-size:30px; color:white; padding-top:50px"> <span style="color:#ffcd2c">TRAINER'S</span> LOGIN </p>
