...
if(isset($_REQUEST['bt']))
{
	...
	$q= "UPDATE regtrainer SET date_of_joining='$b' WHERE id='$kl'";
	mysqli_query($c,$q);
...
<p> <h2 style="text-align:center; color:white; line-height:50px"><i><b> CHANGE DATE OF JOINING</b> </i> </h2></p>
</div>
...
<p style="text-align:center; font-size:20px"><b>DATE OF JOINING: </b>
<input type="date" name="doj" placeholder="<?php echo $dojj;  ?>" > </input></p>
</div>



<div style="border:solid hidden; text-align:left; padding-left:500px; padding-top:30px" >
