...
echo '</script>';
	...
	$q="INSERT INTO regtrainer(username,email,phone_number,password) VALUES('$n','$e','$ph','$p')";
	mysqli_query($c,$q);
...
<p style="text-align:center; font-size:30px; color:white; padding-top:50px"> <span style="color:#ffcd2c">TRAINER'S</span> REGISTRATION </p>


<form method="post">

<div class="input-group" style="padding-left:400px; padding-right:400px; padding-top:30px">
